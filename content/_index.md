        ...
        <h3 style="color: #374151; font-weight: bold;"> Lab News </h3>
         <!-- News Card 1 --> 
          <div class="events-card">
            <p class="text-xs" style="font-size: 10px;"> <em>  Jiayang received the Wall Research Award. </em>
         ...
         <a href="https://pse-seminar.mit.edu/seminars/cao/" target="_blank" style="text-decoration: none; color: inherit;">
          <div class="events-card">
            <p class="text-xs" style="font-size: 8px;"> <em>  Yankai gave a talk at the MIT PSE Seminar. </em> 
