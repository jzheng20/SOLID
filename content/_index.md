  ...
  - block: tag_cloud
    ...
    content:
      ...
      text: |
         ...
         <div style="display: flex; align-items: center; gap: 2rem;">
         <div class="text-center" style="max-width: 600px;">
         <p class="text-xl font-light mt-2">The goal is to make these developments accessible to academic and industrial users by implementing algorithms on easy-to-use and extensible software libraries.</p>
